...
// ✅ 부수 효과란?
// --------------------------------------------------------------------------
// - [x] 부수 효과(Side effects)란? vs 부작용(Negative Side effects)
// - [x] 부수 효과 없는 함수 코드의 장점
// - [x] 부수 효과, 과연 나쁜 것일까? 🧐
// 부수 효과란? 사용자와 상호 작용 : 웹 API 활용, 접근성 준수 등...
// --------------------------------------------------------------------------

// ※ 리액트 입장
// 순수함수 = 렌더링 (동일 입력 → 동일 출력)
// 부수효과 = 사용자와 상호작용 : 웹API활용, 접근성 준수 등 → 이벤트 핸들러, 이펙트 함수
